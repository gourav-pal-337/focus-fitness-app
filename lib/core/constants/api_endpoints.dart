...
class Endpoints {
  ...
  // static const String baseUrl = 'https://gmrwk6wb-4000.inc1.devtunnels.ms/api/mobile';
  // static const String baseUrl = 'https://sl5n9v1k-4000.inc1.devtunnels.ms/api/mobile'; //sahil dev
  ...
  static String getSessionSummary(String bookingId) => '/bookings/$bookingId/summary';
}
