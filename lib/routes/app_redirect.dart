  ...
  if (isSplash) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (token == null || token.isEmpty) {
        ...
        final isTwoFactorEnabled = await LocalStorageService.getTwoFactorAuthEnabled();
        ...
        try {
          ...
          if (success) {
            ...
            if (userProvider.error?.contains('401') == true || 
                userProvider.error?.toLowerCase().contains('unauthorized') == true ||
                userProvider.error?.toLowerCase().contains('session expired') == true) {
